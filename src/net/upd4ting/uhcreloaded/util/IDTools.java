...
public class IDTools {
    ...
    public IDTools() {
        ...
        IdList.put(5.0, Material.OAK_WOOD_PLANK);
        IdList.put(5.1, Material.SPRUCE_WOOD_PLANK);
        IdList.put(5.2, Material.BIRCH_WOOD_PLANK);
        IdList.put(5.3, Material.JUNGLE_WOOD_PLANK);
        IdList.put(5.4, Material.ACACIA_WOOD_PLANK);
        IdList.put(5.5, Material.DARK_OAK_WOOD_PLANK);
        ...
        IdList.put(8.0, Material.FLOWING_WATER);
        IdList.put(9.0, Material.STILL_WATER);
        IdList.put(10.0, Material.FLOWING_LAVA);
        IdList.put(11.0, Material.STILL_LAVA);
        ...
        IdList.put(21.0, Material.LAPIS_LAZULI_ORE);
        IdList.put(22.0, Material.LAPIS_LAZULI_BLOCK);
        ...
        IdList.put(31.0, Material.DEAD_SHRUB);
        ...
        IdList.put(43.0, Material.DOUBLE_STONE_SLAB);
        IdList.put(43.1, Material.DOUBLE_SANDSTONE_SLAB);
        IdList.put(43.2, Material.DOUBLE_WOODEN_SLAB);
        IdList.put(43.3, Material.DOUBLE_COBBLESTONE_SLAB);
        IdList.put(43.4, Material.DOUBLE_BRICK_SLAB);
        IdList.put(43.5, Material.DOUBLE_STONE_BRICK_SLAB);
        IdList.put(43.6, Material.DOUBLE_NETHER_BRICK_SLAB);
        IdList.put(43.7, Material.DOUBLE_QUARTZ_SLAB);
        IdList.put(44.0, Material.STONE_SLAB);
        IdList.put(44.1, Material.SANDSTONE_SLAB);
        IdList.put(44.2, Material.WOODEN_SLAB);
        ...
        IdList.put(48.0, Material.MOSS_STONE);
        IdList.put(49.0, Material.OBSIDIAN);
        IdList.put(50.0, Material.TORCH);
        IdList.put(51.0, Material.FIRE);
        IdList.put(52.0, Material.MONSTER_SPAWNER);
        IdList.put(53.0, Material.OAK_WOOD_STAIRS);
        ...
        IdList.put(59.0, Material.WHEAT_CROPS);
        IdList.put(60.0, Material.FARMLAND);
        IdList.put(61.0, Material.FURNACE);
        IdList.put(62.0, Material.BURNING_FURNACE);
        IdList.put(63.0, Material.STANDING_SIGN_BLOCK);
        IdList.put(64.0, Material.OAK_DOOR_BLOCK);
        IdList.put(65.0, Material.LADDER);
        IdList.put(66.0, Material.RAIL);
        IdList.put(67.0, Material.COBBLESTONE_STAIRS);
        IdList.put(68.0, Material.WALL_MOUNTED_SIGN_BLOCK);
        IdList.put(69.0, Material.LEVER);
        IdList.put(70.0, Material.STONE_PRESSURE_PLATE);
        IdList.put(71.0, Material.IRON_DOOR_BLOCK);
        IdList.put(72.0, Material.WOODEN_PRESSURE_PLATE);
        IdList.put(73.0, Material.REDSTONE_ORE);
        IdList.put(74.0, Material.GLOWING_REDSTONE_ORE);
        IdList.put(75.0, Material.REDSTONE_TORCH_(OFF));
        IdList.put(76.0, Material.REDSTONE_TORCH_(ON));
        ...
        IdList.put(83.0, Material.SUGAR_CANES);
        ...
        IdList.put(91.0, Material.JACK_OLANTERN);
        IdList.put(92.0, Material.CAKE_BLOCK);
        IdList.put(93.0, Material.REDSTONE_REPEATER_BLOCK_(OFF));
        IdList.put(94.0, Material.REDSTONE_REPEATER_BLOCK_(ON));
        ...
        IdList.put(96.0, Material.WOODEN_TRAPDOOR);
        IdList.put(97.0, Material.STONE_MONSTER_EGG);
        IdList.put(97.1, Material.COBBLESTONE_MONSTER_EGG);
        IdList.put(97.2, Material.STONE_BRICK_MONSTER_EGG);
        IdList.put(97.3, Material.MOSSY_STONE_BRICK_MONSTER_EGG);
        IdList.put(97.4, Material.CRACKED_STONE_BRICK_MONSTER_EGG);
        IdList.put(97.5, Material.CHISELED_STONE_BRICK_MONSTER_EGG);
        ...
        IdList.put(116.0, Material.ENCHANTMENT_TABLE);
        ...
        IdList.put(123.0, Material.REDSTONE_LAMP_(INACTIVE));
        IdList.put(124.0, Material.REDSTONE_LAMP_(ACTIVE));
        IdList.put(125.0, Material.DOUBLE_OAK_WOOD_SLAB);
        IdList.put(125.1, Material.DOUBLE_SPRUCE_WOOD_SLAB);
        IdList.put(125.2, Material.DOUBLE_BIRCH_WOOD_SLAB);
        IdList.put(125.3, Material.DOUBLE_JUNGLE_WOOD_SLAB);
        IdList.put(125.4, Material.DOUBLE_ACACIA_WOOD_SLAB);
        IdList.put(125.5, Material.DOUBLE_DARK_OAK_WOOD_SLAB);
        IdList.put(126.0, Material.OAK_WOOD_SLAB);
        IdList.put(126.1, Material.SPRUCE_WOOD_SLAB);
        IdList.put(126.2, Material.BIRCH_WOOD_SLAB);
        IdList.put(126.3, Material.JUNGLE_WOOD_SLAB);
        IdList.put(126.4, Material.ACACIA_WOOD_SLAB);
        IdList.put(126.5, Material.DARK_OAK_WOOD_SLAB);
        ...
        IdList.put(134.0, Material.SPRUCE_WOOD_STAIRS);
        IdList.put(135.0, Material.BIRCH_WOOD_STAIRS);
        IdList.put(136.0, Material.JUNGLE_WOOD_STAIRS);
        ...
        IdList.put(143.0, Material.WOODEN_BUTTON);
        IdList.put(144.0, Material.MOB_HEAD);
        IdList.put(145.0, Material.ANVIL);
        IdList.put(146.0, Material.TRAPPED_CHEST);
        IdList.put(147.0, Material.WEIGHTED_PRESSURE_PLATE_(LIGHT));
        IdList.put(148.0, Material.WEIGHTED_PRESSURE_PLATE_(HEAVY));
        IdList.put(149.0, Material.REDSTONE_COMPARATOR_(INACTIVE));
        IdList.put(150.0, Material.REDSTONE_COMPARATOR_(ACTIVE));
        IdList.put(151.0, Material.DAYLIGHT_SENSOR);
        ...
        IdList.put(155.2, Material.PILLAR_QUARTZ_BLOCK);
        IdList.put(156.0, Material.QUARTZ_STAIRS);
        IdList.put(157.0, Material.ACTIVATOR_RAIL);
        IdList.put(158.0, Material.DROPPER);
        IdList.put(159.0, Material.WHITE_HARDENED_CLAY);
        IdList.put(159.1, Material.ORANGE_HARDENED_CLAY);
        IdList.put(159.2, Material.MAGENTA_HARDENED_CLAY);
        IdList.put(159.3, Material.LIGHT_BLUE_HARDENED_CLAY);
        IdList.put(159.4, Material.YELLOW_HARDENED_CLAY);
        IdList.put(159.5, Material.LIME_HARDENED_CLAY);
        IdList.put(159.6, Material.PINK_HARDENED_CLAY);
        IdList.put(159.7, Material.GRAY_HARDENED_CLAY);
        IdList.put(159.8, Material.LIGHT_GRAY_HARDENED_CLAY);
        IdList.put(159.9, Material.CYAN_HARDENED_CLAY);
        IdList.put(159.10, Material.PURPLE_HARDENED_CLAY);
        IdList.put(159.11, Material.BLUE_HARDENED_CLAY);
        IdList.put(159.12, Material.BROWN_HARDENED_CLAY);
        IdList.put(159.13, Material.GREEN_HARDENED_CLAY);
        IdList.put(159.14, Material.RED_HARDENED_CLAY);
        IdList.put(159.15, Material.BLACK_HARDENED_CLAY);
        ...
        IdList.put(163.0, Material.ACACIA_WOOD_STAIRS);
        IdList.put(164.0, Material.DARK_OAK_WOOD_STAIRS);
        ...
        IdList.put(170.0, Material.HAY_BALE);
        ...
        IdList.put(172.0, Material.HARDENED_CLAY);
        IdList.put(173.0, Material.BLOCK_OF_COAL);
        IdList.put(174.0, Material.PACKED_ICE);
        IdList.put(175.0, Material.SUNFLOWER);
        IdList.put(175.1, Material.LILAC);
        IdList.put(175.2, Material.DOUBLE_TALLGRASS);
        IdList.put(175.3, Material.LARGE_FERN);
        IdList.put(175.4, Material.ROSE_BUSH);
        IdList.put(175.5, Material.PEONY);
        IdList.put(176.0, Material.FREE-STANDING_BANNER);
        IdList.put(177.0, Material.WALL-MOUNTED_BANNER);
        IdList.put(178.0, Material.INVERTED_DAYLIGHT_SENSOR);
        ...
        IdList.put(181.0, Material.DOUBLE_RED_SANDSTONE_SLAB);
        ...
        IdList.put(193.0, Material.SPRUCE_DOOR_BLOCK);
        IdList.put(194.0, Material.BIRCH_DOOR_BLOCK);
        IdList.put(195.0, Material.JUNGLE_DOOR_BLOCK);
        IdList.put(196.0, Material.ACACIA_DOOR_BLOCK);
        IdList.put(197.0, Material.DARK_OAK_DOOR_BLOCK);
        ...
        IdList.put(204.0, Material.PURPUR_DOUBLE_SLAB);
        IdList.put(205.0, Material.PURPUR_SLAB);
        IdList.put(206.0, Material.END_STONE_BRICKS);
        IdList.put(207.0, Material.BEETROOT_BLOCK);
        ...
        IdList.put(215.0, Material.RED_NETHER_BRICK);
        ...
        IdList.put(299.0, Material.LEATHER_TUNIC);
        IdList.put(300.0, Material.LEATHER_PANTS);
        ...
        IdList.put(319.0, Material.RAW_PORKCHOP);
        ...
        IdList.put(338.0, Material.SUGAR_CANES);
        IdList.put(339.0, Material.PAPER);
        IdList.put(340.0, Material.BOOK);
        IdList.put(341.0, Material.SLIMEBALL);
        IdList.put(342.0, Material.MINECART_WITH_CHEST);
        IdList.put(343.0, Material.MINECART_WITH_FURNACE);
        ...
        IdList.put(349.0, Material.RAW_FISH);
        IdList.put(349.1, Material.RAW_SALMON);
        IdList.put(349.2, Material.CLOWNFISH);
        IdList.put(349.3, Material.PUFFERFISH);
        IdList.put(350.0, Material.COOKED_FISH);
        IdList.put(350.1, Material.COOKED_SALMON);
        IdList.put(351.0, Material.INK_SACK);
        IdList.put(351.1, Material.ROSE_RED);
        IdList.put(351.2, Material.CACTUS_GREEN);
        IdList.put(351.3, Material.COCO_BEANS);
        ...
        IdList.put(355.0, Material.BED);
        IdList.put(356.0, Material.REDSTONE_REPEATER);
        ...
        IdList.put(363.0, Material.RAW_BEEF);
        IdList.put(364.0, Material.STEAK);
        IdList.put(365.0, Material.RAW_CHICKEN);
        ...
        IdList.put(381.0, Material.EYE_OF_ENDER);
        IdList.put(382.0, Material.GLISTERING_MELON);
        IdList.put(383.4, Material.SPAWN_ELDER_GUARDIAN);
        IdList.put(383.5, Material.SPAWN_WITHER_SKELETON);
        IdList.put(383.6, Material.SPAWN_STRAY);
        IdList.put(383.23, Material.SPAWN_HUSK);
        IdList.put(383.27, Material.SPAWN_ZOMBIE_VILLAGER);
        IdList.put(383.28, Material.SPAWN_SKELETON_HORSE);
        IdList.put(383.29, Material.SPAWN_ZOMBIE_HORSE);
        IdList.put(383.31, Material.SPAWN_DONKEY);
        IdList.put(383.32, Material.SPAWN_MULE);
        IdList.put(383.34, Material.SPAWN_EVOKER);
        IdList.put(383.35, Material.SPAWN_VEX);
        IdList.put(383.36, Material.SPAWN_VINDICATOR);
        IdList.put(383.50, Material.SPAWN_CREEPER);
        IdList.put(383.51, Material.SPAWN_SKELETON);
        IdList.put(383.52, Material.SPAWN_SPIDER);
        IdList.put(383.54, Material.SPAWN_ZOMBIE);
        IdList.put(383.55, Material.SPAWN_SLIME);
        IdList.put(383.56, Material.SPAWN_GHAST);
        IdList.put(383.57, Material.SPAWN_ZOMBIE_PIGMAN);
        IdList.put(383.58, Material.SPAWN_ENDERMAN);
        IdList.put(383.59, Material.SPAWN_CAVE_SPIDER);
        IdList.put(383.60, Material.SPAWN_SILVERFISH);
        IdList.put(383.61, Material.SPAWN_BLAZE);
        IdList.put(383.62, Material.SPAWN_MAGMA_CUBE);
        IdList.put(383.65, Material.SPAWN_BAT);
        IdList.put(383.66, Material.SPAWN_WITCH);
        IdList.put(383.67, Material.SPAWN_ENDERMITE);
        IdList.put(383.68, Material.SPAWN_GUARDIAN);
        IdList.put(383.69, Material.SPAWN_SHULKER);
        IdList.put(383.90, Material.SPAWN_PIG);
        IdList.put(383.91, Material.SPAWN_SHEEP);
        IdList.put(383.92, Material.SPAWN_COW);
        IdList.put(383.93, Material.SPAWN_CHICKEN);
        IdList.put(383.94, Material.SPAWN_SQUID);
        IdList.put(383.95, Material.SPAWN_WOLF);
        IdList.put(383.96, Material.SPAWN_MOOSHROOM);
        IdList.put(383.98, Material.SPAWN_OCELOT);
        IdList.put(383.100, Material.SPAWN_HORSE);
        IdList.put(383.101, Material.SPAWN_RABBIT);
        IdList.put(383.102, Material.SPAWN_POLAR_BEAR);
        IdList.put(383.103, Material.SPAWN_LLAMA);
        IdList.put(383.105, Material.SPAWN_PARROT);
        IdList.put(383.120, Material.SPAWN_VILLAGER);
        IdList.put(384.0, Material.BOTTLE_O_ENCHANTING);
        IdList.put(385.0, Material.FIRE_CHARGE);
        IdList.put(386.0, Material.BOOK_AND_QUILL);
        ...
        IdList.put(395.0, Material.EMPTY_MAP);
        IdList.put(396.0, Material.GOLDEN_CARROT);
        IdList.put(397.0, Material.MOB_HEAD_(SKELETON));
        IdList.put(397.1, Material.MOB_HEAD_(WITHER_SKELETON));
        IdList.put(397.2, Material.MOB_HEAD_(ZOMBIE));
        IdList.put(397.3, Material.MOB_HEAD_(HUMAN));
        IdList.put(397.4, Material.MOB_HEAD_(CREEPER));
        IdList.put(397.5, Material.MOB_HEAD_(DRAGON));
        ...
        IdList.put(404.0, Material.REDSTONE_COMPARATOR);
        IdList.put(405.0, Material.NETHER_BRICK);
        IdList.put(406.0, Material.NETHER_QUARTZ);
        IdList.put(407.0, Material.MINECART_WITH_TNT);
        IdList.put(408.0, Material.MINECART_WITH_HOPPER);
        IdList.put(409.0, Material.PRISMARINE_SHARD);
        IdList.put(410.0, Material.PRISMARINE_CRYSTALS);
        IdList.put(411.0, Material.RAW_RABBIT);
        IdList.put(412.0, Material.COOKED_RABBIT);
        IdList.put(413.0, Material.RABBIT_STEW);
        IdList.put(414.0, Material.RABBIT'S_FOOT);
        ...
        IdList.put(422.0, Material.MINECART_WITH_COMMAND_BLOCK);
        IdList.put(423.0, Material.RAW_MUTTON);
        IdList.put(424.0, Material.COOKED_MUTTON);
        IdList.put(425.0, Material.BANNER);
        ...
        IdList.put(437.0, Material.DRAGON'S_BREATH);
        ...
        IdList.put(2256.0, Material.13_DISC);
        IdList.put(2257.0, Material.CAT_DISC);
        IdList.put(2258.0, Material.BLOCKS_DISC);
        IdList.put(2259.0, Material.CHIRP_DISC);
        IdList.put(2260.0, Material.FAR_DISC);
        IdList.put(2261.0, Material.MALL_DISC);
        IdList.put(2262.0, Material.MELLOHI_DISC);
        IdList.put(2263.0, Material.STAL_DISC);
        IdList.put(2264.0, Material.STRAD_DISC);
        IdList.put(2265.0, Material.WARD_DISC);
        IdList.put(2266.0, Material.11_DISC);
        IdList.put(2267.0, Material.WAIT_DISC);
